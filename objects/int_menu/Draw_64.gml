...
draw_sprite_ext(spr_LOGO, 0, (ideal_width/2)-1, (ideal_height/3), 1, 1, 0, c_black, 1)
draw_sprite_ext(spr_LOGO, 0, (ideal_width/2)+1, (ideal_height/3), 1, 1, 0, c_black, 1)
draw_sprite_ext(spr_LOGO, 0, (ideal_width/2), (ideal_height/3)-1, 1, 1, 0, c_black, 1)
draw_sprite_ext(spr_LOGO, 0, (ideal_width/2), (ideal_height/3)+1, 1, 1, 0, c_black, 1)

draw_sprite(spr_LOGO, 0, ideal_width/2, (ideal_height/3))
if show <=60{
